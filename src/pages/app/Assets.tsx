...
import { Monitor, Plus, Search, Filter, Server, Laptop, Smartphone } from 'lucide-react';
    ...
    >
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-slate-500">Track internal and client IT assets.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        {[
          { label: 'Total Assets', value: '142', color: 'text-blue-600', bg: 'bg-blue-50', icon: Monitor },
          { label: 'Servers', value: '12', color: 'text-purple-600', bg: 'bg-purple-50', icon: Server },
          { label: 'Workstations', value: '86', color: 'text-indigo-600', bg: 'bg-indigo-50', icon: Laptop },
          { label: 'Mobile Devices', value: '44', color: 'text-emerald-600', bg: 'bg-emerald-50', icon: Smartphone }
        ].map((kpi, i) => (
          <div key={i} className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm flex items-center gap-4 hover:shadow-md transition-shadow">
